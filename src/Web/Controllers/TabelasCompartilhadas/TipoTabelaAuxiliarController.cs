...
using RhSensoERP.Web.Services.TabelasCompartilhadas.TipoTabelaAuxiliar;
...
/// </summary>
[Authorize]
public class TipoTabelaAuxiliarController 
    : BaseCrudController<TipoTabelaAuxiliarDto, CreateTipoTabelaAuxiliarRequest, UpdateTipoTabelaAuxiliarRequest, string>
{
    // =========================================================================
    ...
    private readonly ITipoTabelaAuxiliarApiService _tipotabelaauxiliarService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public TipoTabelaAuxiliarController(
        ITipoTabelaAuxiliarApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<TipoTabelaAuxiliarController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _tipotabelaauxiliarService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new TipoTabelaAuxiliarListViewModel
        {
        ...
        return View("~/Views/TabelasCompartilhadas/TipoTabelaAuxiliar/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateTipoTabelaAuxiliarRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] string id, [FromBody] UpdateTipoTabelaAuxiliarRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(string id, [FromBody] UpdateTipoTabelaAuxiliarRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
