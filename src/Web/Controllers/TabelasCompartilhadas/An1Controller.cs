...
using RhSensoERP.Web.Services.TabelasCompartilhadas.An1;
...
/// <summary>
/// Controller para gerenciamento de Tabela de Bancos.
    ...
    : BaseCrudController<An1Dto, CreateAn1Request, UpdateAn1Request, Guid>
{
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        return View("~/Views/TabelasCompartilhadas/An1/Index.cshtml", viewModel);
    }
