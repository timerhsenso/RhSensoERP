...
using RhSensoERP.Web.Services.GestaoDePessoas.Tvin1;
...
/// </summary>
[Authorize]
public class Tvin1Controller 
    : BaseCrudController<Tvin1Dto, CreateTvin1Request, UpdateTvin1Request, Guid>
{
    // =========================================================================
    ...
    private readonly ITvin1ApiService _tvin1Service;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public Tvin1Controller(
        ITvin1ApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<Tvin1Controller> logger)
        : base(apiService, permissionsCache, logger)
    {
        _tvin1Service = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new Tvin1ListViewModel
        {
        ...
        return View("~/Views/GestaoDePessoas/Tvin1/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateTvin1Request dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateTvin1Request dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateTvin1Request dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
