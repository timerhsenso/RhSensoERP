...
using RhSensoERP.Web.Services.GestaoDePessoas.An1;
...
/// <summary>
/// Controller para gerenciamento de Banco.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class An1Controller 
    : BaseCrudController<An1Dto, CreateAn1Request, UpdateAn1Request, Guid>
{
    // =========================================================================
    ...
    private readonly IAn1ApiService _an1Service;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public An1Controller(
        IAn1ApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<An1Controller> logger)
        : base(apiService, permissionsCache, logger)
    {
        _an1Service = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new An1ListViewModel
        {
        ...
        return View("~/Views/GestaoDePessoas/An1/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateAn1Request dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateAn1Request dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateAn1Request dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
