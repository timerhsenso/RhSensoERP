...
using RhSensoERP.Web.Services.GestaoDePessoas.TreTiposTreinamento;
using RhSensoERP.Web.Services.Permissions;

namespace RhSensoERP.Web.Controllers.GestaoDePessoas;
...
/// <summary>
/// Controller para gerenciamento de Tipos de Treinamento.
    ...
    : BaseCrudController<TreTiposTreinamentoDto, CreateTreTiposTreinamentoRequest, UpdateTreTiposTreinamentoRequest, int>
{
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        return View("~/Views/GestaoDePessoas/TreTiposTreinamento/Index.cshtml", viewModel);
    }
