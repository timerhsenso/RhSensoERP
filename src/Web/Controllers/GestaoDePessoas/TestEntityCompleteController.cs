...
using RhSensoERP.Web.Services.GestaoDePessoas.TestEntityComplete;
...
/// <summary>
/// Controller para gerenciamento de Test Entity Complete.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class TestEntityCompleteController 
    : BaseCrudController<TestEntityCompleteDto, CreateTestEntityCompleteRequest, UpdateTestEntityCompleteRequest, int>
{
    // =========================================================================
    ...
    private readonly ITestEntityCompleteApiService _testentitycompleteService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public TestEntityCompleteController(
        ITestEntityCompleteApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<TestEntityCompleteController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _testentitycompleteService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new TestEntityCompleteListViewModel
        {
        ...
        return View("~/Views/GestaoDePessoas/TestEntityComplete/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateTestEntityCompleteRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateTestEntityCompleteRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateTestEntityCompleteRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
