...
using RhSensoERP.Web.Services.GestaoDePessoas.BasFeriados;
...
/// <summary>
/// Controller para gerenciamento de BasFeriados.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class BasFeriadosController 
    : BaseCrudController<BasFeriadosDto, CreateBasFeriadosRequest, UpdateBasFeriadosRequest, int>
{
    // =========================================================================
    ...
    private readonly IBasFeriadosApiService _basferiadosService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public BasFeriadosController(
        IBasFeriadosApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<BasFeriadosController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _basferiadosService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new BasFeriadosListViewModel
        {
        ...
        return View("~/Views/GestaoDePessoas/BasFeriados/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateBasFeriadosRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateBasFeriadosRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateBasFeriadosRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
