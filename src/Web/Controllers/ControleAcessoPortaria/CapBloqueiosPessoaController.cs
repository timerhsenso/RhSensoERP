...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapBloqueiosPessoa;
...
/// <summary>
/// Controller para gerenciamento de CapBloqueiosPessoa.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapBloqueiosPessoaController 
    : BaseCrudController<CapBloqueiosPessoaDto, CreateCapBloqueiosPessoaRequest, UpdateCapBloqueiosPessoaRequest, int>
{
    // =========================================================================
    ...
    private readonly ICapBloqueiosPessoaApiService _capbloqueiospessoaService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapBloqueiosPessoaController(
        ICapBloqueiosPessoaApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapBloqueiosPessoaController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _capbloqueiospessoaService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapBloqueiosPessoaListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapBloqueiosPessoa/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapBloqueiosPessoaRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapBloqueiosPessoaRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapBloqueiosPessoaRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _capbloqueiospessoaService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
