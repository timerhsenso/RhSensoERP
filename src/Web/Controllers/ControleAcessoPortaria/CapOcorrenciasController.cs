...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapOcorrencias;
...
/// <summary>
/// Controller para gerenciamento de CapOcorrencias.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapOcorrenciasController 
    : BaseCrudController<CapOcorrenciasDto, CreateCapOcorrenciasRequest, UpdateCapOcorrenciasRequest, int>
{
    // =========================================================================
    ...
    private readonly ICapOcorrenciasApiService _capocorrenciasService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapOcorrenciasController(
        ICapOcorrenciasApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapOcorrenciasController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _capocorrenciasService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapOcorrenciasListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapOcorrencias/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapOcorrenciasRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapOcorrenciasRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapOcorrenciasRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _capocorrenciasService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
