...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapResponsaveisContrato;
...
/// <summary>
/// Controller para gerenciamento de CapResponsaveisContrato.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapResponsaveisContratoController 
    : BaseCrudController<CapResponsaveisContratoDto, CreateCapResponsaveisContratoRequest, UpdateCapResponsaveisContratoRequest, int>
{
    // =========================================================================
    ...
    private readonly ICapResponsaveisContratoApiService _capresponsaveiscontratoService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapResponsaveisContratoController(
        ICapResponsaveisContratoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapResponsaveisContratoController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _capresponsaveiscontratoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapResponsaveisContratoListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapResponsaveisContrato/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapResponsaveisContratoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapResponsaveisContratoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapResponsaveisContratoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _capresponsaveiscontratoService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
