...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapHistoricoBloqueios;
...
/// <summary>
/// Controller para gerenciamento de CapHistoricoBloqueios.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapHistoricoBloqueiosController 
    : BaseCrudController<CapHistoricoBloqueiosDto, CreateCapHistoricoBloqueiosRequest, UpdateCapHistoricoBloqueiosRequest, long>
{
    // =========================================================================
    ...
    private readonly ICapHistoricoBloqueiosApiService _caphistoricobloqueiosService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapHistoricoBloqueiosController(
        ICapHistoricoBloqueiosApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapHistoricoBloqueiosController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _caphistoricobloqueiosService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapHistoricoBloqueiosListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapHistoricoBloqueios/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapHistoricoBloqueiosRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] long id, [FromBody] UpdateCapHistoricoBloqueiosRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(long id, [FromBody] UpdateCapHistoricoBloqueiosRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> DeleteMultiple([FromBody] List<long> ids)
    {
