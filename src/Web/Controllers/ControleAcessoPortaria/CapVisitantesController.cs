...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapVisitantes;
...
/// <summary>
/// Controller para gerenciamento de teste1.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapVisitantesController 
    : BaseCrudController<CapVisitantesDto, CreateCapVisitantesRequest, UpdateCapVisitantesRequest, int>
{
    // =========================================================================
    ...
    private readonly ICapVisitantesApiService _capvisitantesService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapVisitantesController(
        ICapVisitantesApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapVisitantesController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _capvisitantesService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapVisitantesListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapVisitantes/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapVisitantesRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapVisitantesRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapVisitantesRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _capvisitantesService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
