...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapTiposOcorrencia;
...
[MenuItem(
    ...
    DisplayName = "Cadastro de Tipo de Ocorrência",
    Icon = "fas fa-table",
    Order = 10,
...
/// <summary>
/// Controller para gerenciamento de Cadastro de Tipo de Ocorrência.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapTiposOcorrenciaController 
    : BaseCrudController<CapTiposOcorrenciaDto, CreateCapTiposOcorrenciaRequest, UpdateCapTiposOcorrenciaRequest, int>
{
    // =========================================================================
    ...
    /// </summary>
    private const string CdSistema = "CAP";

    private readonly ICapTiposOcorrenciaApiService _captiposocorrenciaService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapTiposOcorrenciaController(
        ICapTiposOcorrenciaApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapTiposOcorrenciaController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _captiposocorrenciaService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapTiposOcorrenciaListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapTiposOcorrencia/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapTiposOcorrenciaRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapTiposOcorrenciaRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapTiposOcorrenciaRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _captiposocorrenciaService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
