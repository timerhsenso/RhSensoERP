...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapContratosFornecedor;
...
/// <summary>
/// Controller para gerenciamento de CapContratosFornecedor.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapContratosFornecedorController 
    : BaseCrudController<CapContratosFornecedorDto, CreateCapContratosFornecedorRequest, UpdateCapContratosFornecedorRequest, int>
{
    // =========================================================================
    ...
    private readonly ICapContratosFornecedorApiService _capcontratosfornecedorService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapContratosFornecedorController(
        ICapContratosFornecedorApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapContratosFornecedorController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _capcontratosfornecedorService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapContratosFornecedorListViewModel
        {
        ...
        return View("~/Views/ControleAcessoPortaria/CapContratosFornecedor/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapContratosFornecedorRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapContratosFornecedorRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapContratosFornecedorRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _capcontratosfornecedorService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
