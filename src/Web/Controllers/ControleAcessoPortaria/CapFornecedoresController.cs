...
using RhSensoERP.Web.Services.ControleAcessoPortaria.CapFornecedores;
...
/// <summary>
/// Controller para gerenciamento de CapFornecedores.
    ...
    : BaseCrudController<CapFornecedoresDto, CreateCapFornecedoresRequest, UpdateCapFornecedoresRequest, int>
{
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        return View("~/Views/ControleAcessoPortaria/CapFornecedores/Index.cshtml", viewModel);
    }
