...
using RhSensoERP.Web.Services.TreinamentoDesenvolvimento.TreTiposTreinamento;
using RhSensoERP.Web.Services.Permissions;

namespace RhSensoERP.Web.Controllers.TreinamentoDesenvolvimento;

// =============================================================================
// MENU ITEM - Configuração para aparecer no menu dinâmico
// =============================================================================
[MenuItem(
    Module = MenuModule.Treinamento,
    DisplayName = "Cadastro de Tipo de Treinamento",
    Icon = "fas fa-table",
    Order = 10,
...
/// <summary>
/// Controller para gerenciamento de Cadastro de Tipo de Treinamento.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class TreTiposTreinamentoController 
    : BaseCrudController<TreTiposTreinamentoDto, CreateTreTiposTreinamentoRequest, UpdateTreTiposTreinamentoRequest, int>
{
    // =========================================================================
    ...
    /// </summary>
    private const string CdSistema = "TRE";

    private readonly ITreTiposTreinamentoApiService _tretipostreinamentoService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public TreTiposTreinamentoController(
        ITreTiposTreinamentoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<TreTiposTreinamentoController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _tretipostreinamentoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new TreTiposTreinamentoListViewModel
        {
        ...
        return View("~/Views/TreinamentoDesenvolvimento/TreTiposTreinamento/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateTreTiposTreinamentoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateTreTiposTreinamentoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateTreTiposTreinamentoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _tretipostreinamentoService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
