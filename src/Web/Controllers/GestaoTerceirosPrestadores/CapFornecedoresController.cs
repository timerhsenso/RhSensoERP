...
using RhSensoERP.Web.Services.GestaoTerceirosPrestadores.CapFornecedores;
...
[MenuItem(
    ...
    DisplayName = "Cadastro de Fonecedores",
    Icon = "fas fa-table",
    Order = 10,
...
/// <summary>
/// Controller para gerenciamento de Cadastro de Fonecedores.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class CapFornecedoresController 
    : BaseCrudController<CapFornecedoresDto, CreateCapFornecedoresRequest, UpdateCapFornecedoresRequest, int>
{
    // =========================================================================
    ...
    private readonly ICapFornecedoresApiService _capfornecedoresService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public CapFornecedoresController(
        ICapFornecedoresApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<CapFornecedoresController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _capfornecedoresService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new CapFornecedoresListViewModel
        {
        ...
        return View("~/Views/GestaoTerceirosPrestadores/CapFornecedores/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateCapFornecedoresRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateCapFornecedoresRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateCapFornecedoresRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _capfornecedoresService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
