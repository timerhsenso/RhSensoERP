...
using RhSensoERP.Web.Services.GestaoTerceirosPrestadores.SHR_CNAE;
...
/// <summary>
/// Controller para gerenciamento de Tabela de CNAE.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class SHR_CNAEController 
    : BaseCrudController<SHR_CNAEDto, CreateSHR_CNAERequest, UpdateSHR_CNAERequest, int>
{
    // =========================================================================
    ...
    /// </summary>
    private const string CdSistema = "SHR";

    private readonly ISHR_CNAEApiService _shr_cnaeService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public SHR_CNAEController(
        ISHR_CNAEApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<SHR_CNAEController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _shr_cnaeService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new SHR_CNAEListViewModel
        {
        ...
        return View("~/Views/GestaoTerceirosPrestadores/SHR_CNAE/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateSHR_CNAERequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateSHR_CNAERequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateSHR_CNAERequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _shr_cnaeService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
