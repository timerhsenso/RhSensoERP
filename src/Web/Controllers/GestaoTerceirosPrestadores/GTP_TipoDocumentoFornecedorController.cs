...
using RhSensoERP.Web.Services.GestaoTerceirosPrestadores.GTP_TipoDocumentoFornecedor;
...
// =============================================================================
[MenuItem(
    Module = MenuModule.GestaoTerceirosPrestadores,
...
/// <summary>
/// Controller para gerenciamento de Tipo de Documento de Fornecedor.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class GTP_TipoDocumentoFornecedorController 
    : BaseCrudController<GTP_TipoDocumentoFornecedorDto, CreateGTP_TipoDocumentoFornecedorRequest, UpdateGTP_TipoDocumentoFornecedorRequest, int>
{
    // =========================================================================
    ...
    private readonly IGTP_TipoDocumentoFornecedorApiService _gtp_tipodocumentofornecedorService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public GTP_TipoDocumentoFornecedorController(
        IGTP_TipoDocumentoFornecedorApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<GTP_TipoDocumentoFornecedorController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _gtp_tipodocumentofornecedorService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new GTP_TipoDocumentoFornecedorListViewModel
        {
        ...
        return View("~/Views/GestaoTerceirosPrestadores/GTP_TipoDocumentoFornecedor/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateGTP_TipoDocumentoFornecedorRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateGTP_TipoDocumentoFornecedorRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateGTP_TipoDocumentoFornecedorRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _gtp_tipodocumentofornecedorService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
