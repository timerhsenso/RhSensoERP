...
using RhSensoERP.Web.Services.GestaoTerceirosPrestadores.GtpArea;
...
/// <summary>
/// Controller para gerenciamento de Áreas.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class GtpAreaController 
    : BaseCrudController<GtpAreaDto, CreateGtpAreaRequest, UpdateGtpAreaRequest, int>
{
    // =========================================================================
    ...
    private readonly IGtpAreaApiService _gtpareaService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public GtpAreaController(
        IGtpAreaApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<GtpAreaController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _gtpareaService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new GtpAreaListViewModel
        {
        ...
        return View("~/Views/GestaoTerceirosPrestadores/GtpArea/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateGtpAreaRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] int id, [FromBody] UpdateGtpAreaRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(int id, [FromBody] UpdateGtpAreaRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
    ...
    public async Task<IActionResult> ToggleAtivo([FromBody] ToggleAtivoRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await _gtpareaService.ToggleAtivoAsync(request.Id, request.Ativo, ct);
