...
using RhSensoERP.Web.Services.AdministracaoPessoal.Sindicato;
...
/// <summary>
/// Controller para gerenciamento de Sindicato.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class SindicatoController 
    : BaseCrudController<SindicatoDto, CreateSindicatoRequest, UpdateSindicatoRequest, Guid>
{
    // =========================================================================
    ...
    private readonly ISindicatoApiService _sindicatoService;
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new SindicatoListViewModel
        {
        ...
        return View("~/Views/AdministracaoPessoal/Sindicato/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateSindicatoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateSindicatoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateSindicatoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
