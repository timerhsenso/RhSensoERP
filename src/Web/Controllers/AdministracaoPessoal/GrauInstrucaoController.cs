...
using RhSensoERP.Web.Services.AdministracaoPessoal.GrauInstrucao;
...
/// <summary>
/// Controller para gerenciamento de Grau de instrucao.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class GrauInstrucaoController 
    : BaseCrudController<GrauInstrucaoDto, CreateGrauInstrucaoRequest, UpdateGrauInstrucaoRequest, Guid>
{
    // =========================================================================
    ...
    private readonly IGrauInstrucaoApiService _grauinstrucaoService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public GrauInstrucaoController(
        IGrauInstrucaoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<GrauInstrucaoController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _grauinstrucaoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new GrauInstrucaoListViewModel
        {
        ...
        return View("~/Views/AdministracaoPessoal/GrauInstrucao/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateGrauInstrucaoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateGrauInstrucaoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateGrauInstrucaoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
