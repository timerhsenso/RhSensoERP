...
using RhSensoERP.Web.Services.AdministracaoPessoal.VinculoEmpregaticio;
...
[MenuItem(
    ...
    DisplayName = "Vinculo Empregaticio",
    Icon = "fas fa-table",
    Order = 10,
...
/// <summary>
/// Controller para gerenciamento de Vinculo Empregaticio.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class VinculoEmpregaticioController 
    : BaseCrudController<VinculoEmpregaticioDto, CreateVinculoEmpregaticioRequest, UpdateVinculoEmpregaticioRequest, Guid>
{
    // =========================================================================
    ...
    private readonly IVinculoEmpregaticioApiService _vinculoempregaticioService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public VinculoEmpregaticioController(
        IVinculoEmpregaticioApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<VinculoEmpregaticioController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _vinculoempregaticioService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new VinculoEmpregaticioListViewModel
        {
        ...
        return View("~/Views/AdministracaoPessoal/VinculoEmpregaticio/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateVinculoEmpregaticioRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateVinculoEmpregaticioRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateVinculoEmpregaticioRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
