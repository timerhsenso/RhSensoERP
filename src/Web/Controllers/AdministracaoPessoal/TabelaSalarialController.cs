...
using RhSensoERP.Web.Services.AdministracaoPessoal.TabelaSalarial;
...
/// <summary>
/// Controller para gerenciamento de Tabela Salarial.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class TabelaSalarialController 
    : BaseCrudController<TabelaSalarialDto, CreateTabelaSalarialRequest, UpdateTabelaSalarialRequest, Guid>
{
    // =========================================================================
    ...
    private readonly ITabelaSalarialApiService _tabelasalarialService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public TabelaSalarialController(
        ITabelaSalarialApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<TabelaSalarialController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _tabelasalarialService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new TabelaSalarialListViewModel
        {
        ...
        return View("~/Views/AdministracaoPessoal/TabelaSalarial/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateTabelaSalarialRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateTabelaSalarialRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateTabelaSalarialRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
