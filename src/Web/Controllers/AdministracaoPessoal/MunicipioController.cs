...
using RhSensoERP.Web.Services.AdministracaoPessoal.Municipio;
...
/// <summary>
/// Controller para gerenciamento de Municipios.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class MunicipioController 
    : BaseCrudController<MunicipioDto, CreateMunicipioRequest, UpdateMunicipioRequest, Guid>
{
    // =========================================================================
    ...
    private readonly IMunicipioApiService _municipioService;
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new MunicipioListViewModel
        {
        ...
        return View("~/Views/AdministracaoPessoal/Municipio/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateMunicipioRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateMunicipioRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateMunicipioRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
