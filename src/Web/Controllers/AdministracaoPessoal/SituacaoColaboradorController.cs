...
using RhSensoERP.Web.Services.AdministracaoPessoal.SituacaoColaborador;
...
/// <summary>
/// Controller para gerenciamento de Situação do Colaborador.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class SituacaoColaboradorController 
    : BaseCrudController<SituacaoColaboradorDto, CreateSituacaoColaboradorRequest, UpdateSituacaoColaboradorRequest, Guid>
{
    // =========================================================================
    ...
    private readonly ISituacaoColaboradorApiService _situacaocolaboradorService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public SituacaoColaboradorController(
        ISituacaoColaboradorApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<SituacaoColaboradorController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _situacaocolaboradorService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new SituacaoColaboradorListViewModel
        {
        ...
        return View("~/Views/AdministracaoPessoal/SituacaoColaborador/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateSituacaoColaboradorRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateSituacaoColaboradorRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateSituacaoColaboradorRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
