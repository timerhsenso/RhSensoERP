...
using RhSensoERP.Web.Services.Seguranca.Funcao;
...
public class FuncaoController 
    : BaseCrudController<FuncaoDto, CreateFuncaoRequest, UpdateFuncaoRequest, string>
{
    // =========================================================================
    ...
    private readonly IFuncaoApiService _funcaoService;
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new FuncaoListViewModel
        {
        ...
        return View("~/Views/Seguranca/Funcao/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateFuncaoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] string id, [FromBody] UpdateFuncaoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(string id, [FromBody] UpdateFuncaoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
