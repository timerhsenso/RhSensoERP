...
using RhSensoERP.Web.Services.Seguranca.UsuarioGrupo;
...
/// <summary>
/// Controller para gerenciamento de Usuário-Grupo.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class UsuarioGrupoController 
    : BaseCrudController<UsuarioGrupoDto, CreateUsuarioGrupoRequest, UpdateUsuarioGrupoRequest, Guid>
{
    // =========================================================================
    ...
    private readonly IUsuarioGrupoApiService _usuariogrupoService;
    ...
    public UsuarioGrupoController(
        IUsuarioGrupoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<UsuarioGrupoController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _usuariogrupoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new UsuarioGrupoListViewModel
        {
        ...
        return View("~/Views/Seguranca/UsuarioGrupo/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateUsuarioGrupoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateUsuarioGrupoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateUsuarioGrupoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
