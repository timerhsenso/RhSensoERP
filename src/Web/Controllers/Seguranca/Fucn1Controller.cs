...
using RhSensoERP.Web.Services.Seguranca.Fucn1;
...
[MenuItem(
    ...
    DisplayName = "Cadastro de Terceiros",
    Icon = "fas fa-table",
    Order = 10,
...
/// <summary>
/// Controller para gerenciamento de Cadastro de Terceiros.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class Fucn1Controller 
    : BaseCrudController<Fucn1Dto, CreateFucn1Request, UpdateFucn1Request, string>
{
    // =========================================================================
    ...
    private readonly IFucn1ApiService _fucn1Service;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public Fucn1Controller(
        IFucn1ApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<Fucn1Controller> logger)
        : base(apiService, permissionsCache, logger)
    {
        _fucn1Service = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new Fucn1ListViewModel
        {
        ...
        return View("~/Views/Seguranca/Fucn1/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateFucn1Request dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] string id, [FromBody] UpdateFucn1Request dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(string id, [FromBody] UpdateFucn1Request dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
