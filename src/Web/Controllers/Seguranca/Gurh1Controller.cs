...
using RhSensoERP.Web.Services.Seguranca.Gurh1;
...
/// </summary>
[Authorize]
public class Gurh1Controller 
    : BaseCrudController<Gurh1Dto, CreateGurh1Request, UpdateGurh1Request, string>
{
    // =========================================================================
    ...
    private readonly IGurh1ApiService _gurh1Service;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public Gurh1Controller(
        IGurh1ApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<Gurh1Controller> logger)
        : base(apiService, permissionsCache, logger)
    {
        _gurh1Service = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new Gurh1ListViewModel
        {
        ...
        return View("~/Views/Seguranca/Gurh1/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateGurh1Request dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] string id, [FromBody] UpdateGurh1Request dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(string id, [FromBody] UpdateGurh1Request dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
