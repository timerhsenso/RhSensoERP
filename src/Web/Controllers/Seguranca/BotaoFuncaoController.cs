...
using RhSensoERP.Web.Services.Seguranca.BotaoFuncao;
...
/// <summary>
/// Controller para gerenciamento de Tabela de Botões.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class BotaoFuncaoController 
    : BaseCrudController<BotaoFuncaoDto, CreateBotaoFuncaoRequest, UpdateBotaoFuncaoRequest, string>
{
    // =========================================================================
    ...
    private readonly IBotaoFuncaoApiService _botaofuncaoService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public BotaoFuncaoController(
        IBotaoFuncaoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<BotaoFuncaoController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _botaofuncaoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new BotaoFuncaoListViewModel
        {
        ...
        return View("~/Views/Seguranca/BotaoFuncao/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateBotaoFuncaoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] string id, [FromBody] UpdateBotaoFuncaoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(string id, [FromBody] UpdateBotaoFuncaoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
