 ...
 * 
 * Implementação específica do CRUD de Tabela Salarial.
 * Estende a classe CrudBase com customizações necessárias.
 * ============================================================================
 */

class TabelaSalarialCrud extends CrudBase {
    constructor(config) {
        super(config);
    ...
    beforeSubmit(formData, isEdit) {
        console.log('📥 [TabelaSalarial] Dados ANTES:', JSON.parse(JSON.stringify(formData)));
    ...
    afterSubmit(data, isEdit) {
        console.log('✅ [TabelaSalarial] Registro salvo:', data);
...
$(document).ready(function () {
    ...
    const crud = new TabelaSalarialCrud({
        controllerName: 'TabelaSalarial',
        apiRoute: '/api/administracaopessoal/tabelasalarial',
        entityName: 'Tabela Salarial',
        entityNamePlural: 'Tabela Salarials',
        idField: 'id',
    ...
    console.log('✅ [TabelaSalarial] JavaScript inicializado com sucesso!');
});
