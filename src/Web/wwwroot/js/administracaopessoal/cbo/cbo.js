/**
 * ============================================================================
 * CBO - JavaScript com Ordenação de Navegações
 * ============================================================================
 * Arquivo: wwwroot/js/administracaopessoal/cbo/cbo.js
 ...
 * 
 * Implementação específica do CRUD de CBO.
 * Estende a classe CrudBase com customizações necessárias.
 * ============================================================================
 */

class CboCrud extends CrudBase {
    constructor(config) {
        super(config);
    ...
    enablePrimaryKeyFields(enable) {
        ...
        if (enable) {
            ...
            console.log('✏️ [Cbo] Campo PK habilitado para edição (criação)');
        } else {
            // Edição: campo readonly
            $pkField.prop('readonly', true)
                    .addClass('bg-light');
            console.log('🔒 [Cbo] Campo PK desabilitado (edição)');
        }
    }
    ...
    beforeSubmit(formData, isEdit) {
        console.log('📥 [Cbo] Dados ANTES:', JSON.parse(JSON.stringify(formData)));
        ...
        cleanData.Dccbo = formData.dccbo || formData.Dccbo || '';
        cleanData.SiNonimo = formData.siNonimo || formData.SiNonimo || '';

        console.log('📤 [Cbo] Dados DEPOIS (PascalCase):', JSON.parse(JSON.stringify(cleanData)));
        return cleanData;
    }
    ...
    afterSubmit(data, isEdit) {
        console.log('✅ [Cbo] Registro salvo:', data);
...
$(document).ready(function () {
    ...
    console.log('🔐 [Cbo] Permissões ativas:', window.crudPermissions);
    ...
    function getCleanId(row, fieldName) {
        ...
        // Log para debug
        if (!id) {
            console.warn('⚠️ [Cbo] ID vazio para row:', row);
        }
    ...
    const crud = new CboCrud({
        controllerName: 'Cbo',
        apiRoute: '/api/administracaopessoal/cbo',
        entityName: 'CBO',
        entityNamePlural: 'CBOs',
        idField: 'id',
    ...
    console.log('✅ [Cbo] JavaScript inicializado com sucesso!');
});
