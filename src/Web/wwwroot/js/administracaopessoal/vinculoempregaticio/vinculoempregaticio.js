...
class VinculoEmpregaticioCrud extends CrudBase {
    constructor(config) {
        super(config);
    ...
    beforeSubmit(formData, isEdit) {
        console.log('📥 [VinculoEmpregaticio] Dados ANTES:', JSON.parse(JSON.stringify(formData)));
    ...
    afterSubmit(data, isEdit) {
        console.log('✅ [VinculoEmpregaticio] Registro salvo:', data);
...
$(document).ready(function () {
    ...
    console.log('✅ [VinculoEmpregaticio] JavaScript inicializado com sucesso!');
});
