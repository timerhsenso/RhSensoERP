/**
 * ============================================================================
 * USUÁRIO-GRUPO - JavaScript com Fix PK Texto
 * ============================================================================
 * Arquivo: wwwroot/js/seguranca/usuariogrupo/usuariogrupo.js
 * Módulo: Seguranca
 ...
 * 
 * Implementação específica do CRUD de Usuário-Grupo.
 * Estende a classe CrudBase com customizações necessárias.
 * ============================================================================
 */

class UsuarioGrupoCrud extends CrudBase {
    constructor(config) {
        super(config);
    ...
    enablePrimaryKeyFields(enable) {
        ...
        console.log(enable 
            ? '✏️ [UsuarioGrupo] Campos PK habilitados para edição (criação)'
            : '🔒 [UsuarioGrupo] Campos PK desabilitados (edição)');
    }
    ...
    beforeSubmit(formData, isEdit) {
        console.log('📥 [UsuarioGrupo] Dados ANTES:', JSON.parse(JSON.stringify(formData)));
        ...
        cleanData.CdUsuario = formData.cdUsuario || formData.CdUsuario || '';
        ...
        console.log('📤 [UsuarioGrupo] Dados DEPOIS (PascalCase):', JSON.parse(JSON.stringify(cleanData)));
        return cleanData;
    }
    ...
    afterSubmit(data, isEdit) {
        console.log('✅ [UsuarioGrupo] Registro salvo:', data);
...
$(document).ready(function () {
    ...
    console.log('🔐 [UsuarioGrupo] Permissões ativas:', window.crudPermissions);
    ...
    function getCleanId(row, fieldName) {{
        ...
        id = String(id).trim();
        if (!id) {{
            console.warn('⚠️ [UsuarioGrupo] ID vazio para row:', row);
        }}
        return id;
    }}
    ...
    const crud = new UsuarioGrupoCrud({
        controllerName: 'UsuarioGrupo',
        apiRoute: '/api/seguranca/usuariogrupo',
        entityName: 'Usuário-Grupo',
        entityNamePlural: 'Usuário-Grupos',
        idField: 'id',
    ...
    console.log('✅ [UsuarioGrupo] JavaScript inicializado com sucesso!');
});
