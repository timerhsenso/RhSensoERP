 ...
 * 
 * Implementação específica do CRUD de Funções do Sistema.
 * Estende a classe CrudBase com customizações necessárias.
 * ============================================================================
 */

class FuncaoCrud extends CrudBase {
    constructor(config) {
        super(config);
    ...
    beforeSubmit(formData, isEdit) {
        console.log('📥 [Funcao] Dados ANTES:', JSON.parse(JSON.stringify(formData)));
    ...
    afterSubmit(data, isEdit) {
        console.log('✅ [Funcao] Registro salvo:', data);
...
$(document).ready(function () {
    ...
    const crud = new FuncaoCrud({
        controllerName: 'Funcao',
    ...
    console.log('✅ [Funcao] JavaScript inicializado com sucesso!');
});
