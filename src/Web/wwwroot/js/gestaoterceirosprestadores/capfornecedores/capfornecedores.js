/**
 * ============================================================================
 * CADASTRO DE FONECEDORES - JavaScript com Fix PK Texto
 * ============================================================================
 * Arquivo: wwwroot/js/gestaoterceirosprestadores/capfornecedores/capfornecedores.js
...
class CapFornecedoresCrud extends CrudBase {
    ...
    enablePrimaryKeyFields(enable) {
        ...
        console.log(enable 
            ? '✏️ [CapFornecedores] Campos PK habilitados para edição (criação)'
            : '🔒 [CapFornecedores] Campos PK desabilitados (edição)');
    }
