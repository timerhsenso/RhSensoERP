/**
 * ============================================================================
 * CADASTRO DE PRESTADORES - JavaScript com Fix PK Texto
 * ============================================================================
 ...
 * 
 * Implementação específica do CRUD de Cadastro de prestadores.
...
class CapColaboradoresFornecedorCrud extends CrudBase {
    ...
    enablePrimaryKeyFields(enable) {
        ...
        console.log(enable 
            ? '✏️ [CapColaboradoresFornecedor] Campos PK habilitados para edição (criação)'
            : '🔒 [CapColaboradoresFornecedor] Campos PK desabilitados (edição)');
    }
...
$(document).ready(function () {
    ...
    const crud = new CapColaboradoresFornecedorCrud({
        ...
        entityName: 'Cadastro de prestadores',
        entityNamePlural: 'Cadastro de prestadoress',
        idField: 'id',
