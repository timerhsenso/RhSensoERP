/**
 * ============================================================================
 * CAPRESPONSAVEISCONTRATO - JavaScript com Checkbox e Toggle Ativo
 * ============================================================================
...
class CapResponsaveisContratoCrud extends CrudBase {
    ...
    beforeSubmit(formData, isEdit) {
        console.log('📥 [CapResponsaveisContrato] Dados ANTES:', JSON.parse(JSON.stringify(formData)));
        ...
        console.log('📤 [CapResponsaveisContrato] Dados DEPOIS (PascalCase):', JSON.parse(JSON.stringify(cleanData)));
        return cleanData;
    }
...
$(document).ready(function () {
    ...
    const crud = new CapResponsaveisContratoCrud({
        controllerName: 'CapResponsaveisContrato',
        entityName: 'CapResponsaveisContrato',
        entityNamePlural: 'CapResponsaveisContratos',
        idField: 'id',
        ...
        exportConfig: {
            ...
            csv: true,
            print: true,
            filename: 'CapResponsaveisContrato'
        }
    });
    ...
    $(document).on('change', '.toggle-ativo', function () {
        ...
        console.log(`🔄 [CapResponsaveisContrato] Toggle Ativo - ID: ${id}, Novo valor: ${newValue}`);
        ...
        toggleDebounceTimer = setTimeout(function () {
            $.ajax({
                url: `/CapResponsaveisContrato/ToggleAtivo`,
                type: 'POST',
                headers: {
                ...
                success: function (response) {
                    if (response.success) {
                        console.log(`✅ [CapResponsaveisContrato] Toggle Ativo atualizado - ID: ${id}`);
                        ...
                        console.error(`❌ [CapResponsaveisContrato] Erro ao atualizar Toggle Ativo:`, response);
                ...
                error: function (xhr) {
                    // Reverte toggle em caso de erro
                    $toggle.prop('checked', currentValue);
                    console.error(`❌ [CapResponsaveisContrato] Erro AJAX Toggle Ativo:`, xhr);
    ...
    console.log('✅ [CapResponsaveisContrato] JavaScript inicializado com sucesso!');
});
