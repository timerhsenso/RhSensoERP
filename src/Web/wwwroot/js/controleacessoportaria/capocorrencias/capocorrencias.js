/**
 * ============================================================================
 * CAPOCORRENCIAS - JavaScript com Checkbox e Toggle Ativo
 * ============================================================================
...
$(document).ready(function () {
    ...
    const columns = [
        ...
        {
            data: 'idColaboradorResponsavel',
            name: 'IdColaboradorResponsavel',
            title: 'IdColaboradorResponsavel',
            orderable: true,
            render: function (data, type, row) {
                return data !== undefined && data !== null ? data : '';
            }
        ...
        // IdFuncionarioResponsavel
        {
            ...
            title: 'IdFuncionarioResponsavel',
            orderable: true,
            render: function (data, type, row) {
                return data !== undefined && data !== null ? data : '';
            }
    ...
    const crud = new CapOcorrenciasCrud({
        controllerName: 'CapOcorrencias',
        entityName: 'CapOcorrencias',
        entityNamePlural: 'CapOcorrenciass',
        idField: 'id',
    ...
    $(document).on('change', '.toggle-ativo', function () {
        ...
        console.log(`🔄 [CapOcorrencias] Toggle Ativo - ID: ${id}, Novo valor: ${newValue}`);
        ...
        toggleDebounceTimer = setTimeout(function () {
            $.ajax({
                url: `/CapOcorrencias/ToggleAtivo`,
                type: 'POST',
                headers: {
                ...
                success: function (response) {
                    if (response.success) {
                        console.log(`✅ [CapOcorrencias] Toggle Ativo atualizado - ID: ${id}`);
                        ...
                        console.error(`❌ [CapOcorrencias] Erro ao atualizar Toggle Ativo:`, response);
                ...
                error: function (xhr) {
                    // Reverte toggle em caso de erro
                    $toggle.prop('checked', currentValue);
                    console.error(`❌ [CapOcorrencias] Erro AJAX Toggle Ativo:`, xhr);
    ...
    console.log('✅ [CapOcorrencias] JavaScript inicializado com sucesso!');
});
