/**
 * ============================================================================
 * CAPHISTORICOBLOQUEIOS - JavaScript com Controle de Permissões
 * ============================================================================
...
class CapHistoricoBloqueiosCrud extends CrudBase {
    ...
    beforeSubmit(formData, isEdit) {
        ...
        cleanData.IdBloqueio = parseInt(formData.idBloqueio || formData.IdBloqueio || 0, 10);
        ...
        cleanData.DataRegistro = formData.dataRegistro || formData.DataRegistro || new Date().toISOString();
...
$(document).ready(function () {
    ...
    window.caphistoricobloqueiosCrud = new CapHistoricoBloqueiosCrud({
    ...
    console.log('✅ [CapHistoricoBloqueios] CRUD inicializado com sucesso (v3.9 - PascalCase)');
});
