...
class CapVisitantesCrud extends CrudBase {
    ...
    beforeSubmit(formData, isEdit) {
        ...
        ['idFuncionarioResponsavel'].forEach(field => {
        ...
        ['RequerResponsavel', 'Ativo'].forEach(field => {
        ...
        console.log('📤 [CapVisitantes] Dados a enviar:', formData);
        return formData;
    }
...
$(document).ready(function () {
    ...
    const columns = [
        ...
        // Coluna de ações
        {
            ...
            render: function (data, type, row) {
                ...
                console.log('🔧 [CapVisitantes] Renderizando ações | ID:', id, '| Row:', row);
    ...
    console.log('✅ [CapVisitantes] CRUD inicializado com sucesso');
});
