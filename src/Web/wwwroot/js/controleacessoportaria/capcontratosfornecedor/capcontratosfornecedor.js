/**
 * ============================================================================
 * CAPCONTRATOSFORNECEDOR - JavaScript com Controle de Permissões
 * ============================================================================
...
class CapContratosFornecedorCrud extends CrudBase {
    ...
    beforeSubmit(formData, isEdit) {
        ...
        // Trata CreatedByUserId nullable (Guid)
        if (formData.createdByUserId === '' || formData.createdByUserId === undefined) {
            formData.createdByUserId = null;
        }

        // Trata UpdatedByUserId nullable (Guid)
        if (formData.updatedByUserId === '' || formData.updatedByUserId === undefined) {
            formData.updatedByUserId = null;
        }


        console.log('📤 [CapContratosFornecedor] Dados a enviar:', formData);
        return formData;
    }
...
$(document).ready(function () {
    ...
    const columns = [
        ...
        // Coluna de ações
        {
            ...
            render: function (data, type, row) {
                ...
                console.log('🔧 [CapContratosFornecedor] Renderizando ações | ID:', id, '| Row:', row);
    ...
    window.capcontratosfornecedorCrud = new CapContratosFornecedorCrud({
    ...
    console.log('✅ [CapContratosFornecedor] CRUD inicializado com sucesso');
});
