/**
 * ============================================================================
 * CAPCONTATOSEMERGENCIA - JavaScript com Checkbox e Toggle Ativo
 * ============================================================================
...
$(document).ready(function () {
    ...
    const crud = new CapContatosEmergenciaCrud({
        controllerName: 'CapContatosEmergencia',
        entityName: 'CapContatosEmergencia',
        entityNamePlural: 'CapContatosEmergencias',
        idField: 'id',
        ...
        exportConfig: {
            ...
            csv: true,
            print: true,
            filename: 'CapContatosEmergencia'
        }
    });
    ...
    $(document).on('change', '.toggle-ativo', function () {
        ...
        console.log(`🔄 [CapContatosEmergencia] Toggle Ativo - ID: ${id}, Novo valor: ${newValue}`);
        ...
        toggleDebounceTimer = setTimeout(function () {
            $.ajax({
                url: `/CapContatosEmergencia/ToggleAtivo`,
                type: 'POST',
                headers: {
                ...
                success: function (response) {
                    if (response.success) {
                        console.log(`✅ [CapContatosEmergencia] Toggle Ativo atualizado - ID: ${id}`);
                        ...
                        console.error(`❌ [CapContatosEmergencia] Erro ao atualizar Toggle Ativo:`, response);
                ...
                error: function (xhr) {
                    // Reverte toggle em caso de erro
                    $toggle.prop('checked', currentValue);
                    console.error(`❌ [CapContatosEmergencia] Erro AJAX Toggle Ativo:`, xhr);
    ...
    console.log('✅ [CapContatosEmergencia] JavaScript inicializado com sucesso!');
});
