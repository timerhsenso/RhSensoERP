...
/// </summary>
public class CboApiService 
    : BaseApiService<CboDto, CreateCboRequest, UpdateCboRequest, Guid>,
      ICboApiService
{
    private const string ApiRoute = "api/administracaopessoal/cbo";
    ...
    // CONSTRUTOR
    // =========================================================================
    public CboApiService(
        HttpClient httpClient,
        ILogger<CboApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[CBO] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[CBO] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[CBO] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
