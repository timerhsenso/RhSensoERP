...
/// <summary>
/// Serviço de API para Vínculo Empregatício.
...
/// </summary>
public class VinculoEmpregaticioApiService 
    : BaseApiService<VinculoEmpregaticioDto, CreateVinculoEmpregaticioRequest, UpdateVinculoEmpregaticioRequest, Guid>,
      IVinculoEmpregaticioApiService
{
    ...
    // CONSTRUTOR
    // =========================================================================
    public VinculoEmpregaticioApiService(
        HttpClient httpClient,
        ILogger<VinculoEmpregaticioApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[VINCULOEMPREGATICIO] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[VINCULOEMPREGATICIO] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[VINCULOEMPREGATICIO] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
