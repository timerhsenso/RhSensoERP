...
/// <summary>
/// Serviço de API para Tabela de Agências.
...
/// </summary>
public class AgenciaBancariaApiService 
    : BaseApiService<AgenciaBancariaDto, CreateAgenciaBancariaRequest, UpdateAgenciaBancariaRequest, Guid>,
      IAgenciaBancariaApiService
{
    private const string ApiRoute = "api/administracaopessoal/agenciabancaria";
    ...
    // CONSTRUTOR
    // =========================================================================
    public AgenciaBancariaApiService(
        HttpClient httpClient,
        ILogger<AgenciaBancariaApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[AGENCIABANCARIA] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[AGENCIABANCARIA] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[AGENCIABANCARIA] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
