...
/// <summary>
/// Serviço de API para Municipios.
...
public class MunicipioApiService 
    : BaseApiService<MunicipioDto, CreateMunicipioRequest, UpdateMunicipioRequest, Guid>,
      IMunicipioApiService
{
    private const string ApiRoute = "api/administracaopessoal/municipio";
    ...
    public MunicipioApiService(
        ...
        ILogger<MunicipioApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[MUNICIPIO] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[MUNICIPIO] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[MUNICIPIO] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
