...
/// <summary>
/// Serviço de API para Grau de instrucao.
...
/// </summary>
public class GrauInstrucaoApiService 
    : BaseApiService<GrauInstrucaoDto, CreateGrauInstrucaoRequest, UpdateGrauInstrucaoRequest, Guid>,
      IGrauInstrucaoApiService
{
    private const string ApiRoute = "api/administracaopessoal/grauinstrucao";
    ...
    // CONSTRUTOR
    // =========================================================================
    public GrauInstrucaoApiService(
        HttpClient httpClient,
        ILogger<GrauInstrucaoApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[GRAUINSTRUCAO] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[GRAUINSTRUCAO] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[GRAUINSTRUCAO] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
