...
public class CargoApiService 
    : BaseApiService<CargoDto, CreateCargoRequest, UpdateCargoRequest, Guid>,
      ICargoApiService
{
    private const string ApiRoute = "api/administracaopessoal/cargo";
    ...
    public CargoApiService(
        ...
        ILogger<CargoApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[CARGO] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[CARGO] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[CARGO] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
