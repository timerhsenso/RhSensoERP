...
/// </summary>
public class TipoTabelaAuxiliarApiService 
    : BaseApiService<TipoTabelaAuxiliarDto, CreateTipoTabelaAuxiliarRequest, UpdateTipoTabelaAuxiliarRequest, string>,
      ITipoTabelaAuxiliarApiService
{
    private const string ApiRoute = "api/tabelascompartilhadas/tipotabelaauxiliar";
    ...
    // CONSTRUTOR
    // =========================================================================
    public TipoTabelaAuxiliarApiService(
        HttpClient httpClient,
        ILogger<TipoTabelaAuxiliarApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<string> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[TIPOTABELAAUXILIAR] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[TIPOTABELAAUXILIAR] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[TIPOTABELAAUXILIAR] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
