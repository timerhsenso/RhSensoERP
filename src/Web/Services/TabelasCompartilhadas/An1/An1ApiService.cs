...
/// <summary>
/// Serviço de API para Tabela de Bancos.
...
/// </summary>
public class An1ApiService 
    : BaseApiService<An1Dto, CreateAn1Request, UpdateAn1Request, Guid>,
      IAn1ApiService
{
    private const string ApiRoute = "api/tabelascompartilhadas/banco";
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[AN1] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
