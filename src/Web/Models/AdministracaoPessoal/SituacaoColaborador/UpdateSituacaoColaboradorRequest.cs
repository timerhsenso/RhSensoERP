...
/// <summary>
/// Request para atualização de Situação do Colaborador.
/// Compatível com backend: UpdateSituacaoColaboradorRequest
/// </summary>
public class UpdateSituacaoColaboradorRequest
{
    /// <summary>
    /// Código
    /// </summary>
