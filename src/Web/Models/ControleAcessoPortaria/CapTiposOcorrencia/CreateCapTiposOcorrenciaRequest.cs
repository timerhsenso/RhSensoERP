...
/// <summary>
/// Request para criação de Cadastro de Tipo de Ocorrência.
/// Compatível com backend: CreateCapTiposOcorrenciaRequest
/// </summary>
public class CreateCapTiposOcorrenciaRequest
{
    /// <summary>
    /// Nome
    /// </summary>
