...
/// <summary>
/// Request para atualizacao de CapColaboradoresFornecedor.
/// Compativel com backend: UpdateCapColaboradoresFornecedorRequest
/// </summary>
public class UpdateCapColaboradoresFornecedorRequest
{
    ...
    [Required(ErrorMessage = "IdFornecedor e obrigatorio")]
    ...
    /// </summary>
    [Display(Name = "Gênero")]
    [StringLength(20, ErrorMessage = "Gênero deve ter no maximo {1} caracteres")]
    ...
    [StringLength(50, ErrorMessage = "Estado Civil deve ter no maximo {1} caracteres")]
    ...
    [Required(ErrorMessage = "Data Admissão e obrigatorio")]
    ...
    /// </summary>
    [Display(Name = "Cargo")]
    [StringLength(100, ErrorMessage = "Cargo deve ter no maximo {1} caracteres")]
