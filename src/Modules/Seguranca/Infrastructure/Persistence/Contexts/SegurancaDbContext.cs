...
namespace RhSensoERP.Modules.Seguranca.Infrastructure.Persistence.Contexts;

/// <summary>
/// DbContext do módulo de Seguranca.
///
...
{
    /// <summary>
    /// Construtor padrão do <see cref="SegurancaDbContext"/>.
    /// </summary>
