...
using RhSensoERP.Modules.TabelasCompartilhadas.Core.Entities;
using RhSensoERP.Shared.Core.Attributes;

namespace RhSensoERP.Modules.TabelasCompartilhadas.Infrastructure.Persistence.Contexts;

/// <summary>
/// DbContext do módulo de TabelasCompartilhadas.
///
...
/// </summary>
public class TabelasCompartilhadasDbContext : DbContext
{
    /// <summary>
    /// Construtor padrão do <see cref="TabelasCompartilhadasDbContext"/>.
    /// </summary>
    public TabelasCompartilhadasDbContext(DbContextOptions<TabelasCompartilhadasDbContext> options)
        : base(options)
    {
    }
