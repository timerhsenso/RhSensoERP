...
using RhSensoERP.Web.Services.Seguranca.HabilitacaoGrupo;
...
/// <summary>
/// Controller para gerenciamento de Habilitação de Grupo.
/// Herda toda a funcionalidade CRUD de BaseCrudController.
/// </summary>
[Authorize]
public class HabilitacaoGrupoController 
    : BaseCrudController<HabilitacaoGrupoDto, CreateHabilitacaoGrupoRequest, UpdateHabilitacaoGrupoRequest, Guid>
{
    // =========================================================================
    ...
    private readonly IHabilitacaoGrupoApiService _habilitacaogrupoService;

    // =========================================================================
    // CONSTRUTOR
    // =========================================================================

    public HabilitacaoGrupoController(
        IHabilitacaoGrupoApiService apiService,
        IUserPermissionsCacheService permissionsCache,
        ILogger<HabilitacaoGrupoController> logger)
        : base(apiService, permissionsCache, logger)
    {
        _habilitacaogrupoService = apiService;
    }
    ...
    public async Task<IActionResult> Index(CancellationToken ct = default)
    {
        ...
        var viewModel = new HabilitacaoGrupoListViewModel
        {
        ...
        return View("~/Views/Seguranca/HabilitacaoGrupo/Index.cshtml", viewModel);
    }
    ...
    public override async Task<IActionResult> Create([FromBody] CreateHabilitacaoGrupoRequest dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromQuery] Guid id, [FromBody] UpdateHabilitacaoGrupoRequest dto)
    {
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public override async Task<IActionResult> Update(Guid id, [FromBody] UpdateHabilitacaoGrupoRequest dto)
    {
        if (!await CanEditAsync(CdFuncao))
        {
            return JsonError("Você não tem permissão para alterar registros nesta tela.");
