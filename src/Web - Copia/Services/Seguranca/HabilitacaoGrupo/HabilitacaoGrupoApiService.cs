...
/// <summary>
/// Serviço de API para Habilitação de Grupo.
...
/// </summary>
public class HabilitacaoGrupoApiService 
    : BaseApiService<HabilitacaoGrupoDto, CreateHabilitacaoGrupoRequest, UpdateHabilitacaoGrupoRequest, Guid>,
      IHabilitacaoGrupoApiService
{
    private const string ApiRoute = "api/seguranca/habilitacaogrupo";
    ...
    // CONSTRUTOR
    // =========================================================================
    public HabilitacaoGrupoApiService(
        HttpClient httpClient,
        ILogger<HabilitacaoGrupoApiService> logger,
    ...
    public async Task<ApiResponse<BatchDeleteResultDto>> DeleteBatchAsync(IEnumerable<Guid> ids)
    {
        try
        {
            ...
            _logger.LogDebug("[HABILITACAOGRUPO] DELETE {Route}/batch - Body: {Body}", _baseEndpoint, json);
        ...
        {
            _logger.LogError(ex, "[HABILITACAOGRUPO] Erro de conexão em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
        ...
        {
            _logger.LogError(ex, "[HABILITACAOGRUPO] Exceção em DeleteBatchAsync");
            return new ApiResponse<BatchDeleteResultDto>
            {
                Success = false,
