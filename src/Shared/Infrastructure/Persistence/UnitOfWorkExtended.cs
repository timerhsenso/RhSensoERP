...
// =============================================================================
// Arquivo: src/Shared/RhSensoERP.Shared.Infrastructure/Persistence/UnitOfWorkExtended.cs
// Descrição: Implementação do Unit of Work estendido para gerenciamento de transações
// NOTA: Implementa IUnitOfWorkExtended, que herda de IUnitOfWork
// =============================================================================
...
/// <summary>
/// Implementação do Unit of Work estendido para gerenciamento de transações.
/// </summary>
/// <typeparam name="TContext">Tipo do DbContext</typeparam>
public class UnitOfWorkExtended<TContext> : IUnitOfWorkExtended
    where TContext : DbContext
{
    private readonly TContext _context;
    private readonly ILogger<UnitOfWorkExtended<TContext>> _logger;
    ...
    /// Construtor.
    /// </summary>
    public UnitOfWorkExtended(
        TContext context,
        ILogger<UnitOfWorkExtended<TContext>> logger,
